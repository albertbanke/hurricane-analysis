...
hurricanes = create_dictionary(names, months, years, max_sustained_winds, 
                              areas_affected, damages, deaths)

#print(hurricanes.get("Cuba I"))


# write your construct hurricane by year dictionary function here:

def create_hurricane_year_dictionary(years, names, months, max_sustained_winds, areas_affected, damages, deaths):
    hurricanes = dict()
    num_hurricanes = len(years)
    for i in range(num_hurricanes):
        hurricanes[years[i]] = {"Year": years[i], 
                                "Name": names[i], 
                                "Month": months[i], 
                                "Max Sustained wind": max_sustained_winds[i], 
                                "Areas Affected": areas_affected[i], 
...
hurricanes_year = create_hurricane_year_dictionary(years, names, months, max_sustained_winds, 
                              areas_affected, damages, deaths)


#You believe that knowing how often each of the areas of the Atlantic are affected 
# by these strong hurricanes is important for making preparations for future hurricanes.
...
def count_of_affected(hurricanes):
    area_investigation = dict()
    for i in hurricanes:
        for values in i:
            key
